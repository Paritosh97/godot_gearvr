...
def configure(env):
    ...
    vrapi_headers = '/home/paritosh97/Desktop/Godot/ovr_sdk_mobile_1.9.0/VrApi/Include/'

    env.Append(CPPPATH=[vrapi_headers])

    vrapi = '/home/paritosh97/Desktop/Godot/ovr_sdk_mobile_1.9.0/VrApi/Libs/Android/armeabi-v7a/Debug/'

    env.Append(LIBPATH=[vrapi])
    env.Append(LIBS=['vrapi'])
